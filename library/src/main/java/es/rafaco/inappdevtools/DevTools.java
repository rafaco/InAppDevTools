...
import es.rafaco.inappdevtools.logic.sources.SourcesManager;
import es.rafaco.inappdevtools.logic.watcher.WatcherManager;
import es.rafaco.inappdevtools.logic.watcher.activityLog.ActivityLogManager;
import es.rafaco.inappdevtools.logic.watcher.activityLog.CustomChuckInterceptor;
import es.rafaco.inappdevtools.logic.initialization.PendingCrashUtil;
import es.rafaco.inappdevtools.logic.utils.AppUtils;
import es.rafaco.inappdevtools.logic.initialization.FirstStartUtil;
...
import es.rafaco.inappdevtools.storage.files.FileProviderUtils;
import es.rafaco.inappdevtools.tools.ToolManager;
import es.rafaco.inappdevtools.view.activities.PermissionActivity;
import es.rafaco.inappdevtools.view.activities.ReportDialogActivity;
import es.rafaco.inappdevtools.view.activities.WelcomeDialogActivity;
import es.rafaco.inappdevtools.view.notifications.NotificationUIService;
import es.rafaco.inappdevtools.view.overlay.OverlayUIService;
import es.rafaco.inappdevtools.view.overlay.screens.errors.CrashDetailScreen;
import es.rafaco.inappdevtools.logic.integrations.RunnableConfig;
import es.rafaco.inappdevtools.view.overlay.screens.log.LogHelper;
import es.rafaco.inappdevtools.view.overlay.screens.report.ReportHelper;
import es.rafaco.inappdevtools.view.overlay.screens.screenshots.ScreenHelper;
import es.rafaco.inappdevtools.logic.integrations.CustomToast;
