...
import es.rafaco.inappdevtools.view.utils.UiUtils;
import es.rafaco.inappdevtools.R;
import es.rafaco.inappdevtools.view.overlay.layers.IconOverlayLayer;
import es.rafaco.inappdevtools.view.overlay.layers.MainOverlayLayer;
import es.rafaco.inappdevtools.view.overlay.layers.OverlayLayer;
import es.rafaco.inappdevtools.view.overlay.layers.RemoveOverlayLayer;
