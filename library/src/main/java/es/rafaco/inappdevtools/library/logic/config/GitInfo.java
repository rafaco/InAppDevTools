...
public class GitInfo {
    ...
    public static final String LOCAL_TRACKED_COUNT = "LOCAL_TRACKED_COUNT";
    public static final String LOCAL_TOTAL_COUNT = "LOCAL_TOTAL_COUNT";
    public static final String LOCAL_UNTRACKED = "LOCAL_UNTRACKED";
    public static final String LOCAL_TRACKED_STATS = "LOCAL_TRACKED_STATS";
    public static final String LOCAL_UNSTAGED_STATS = "LOCAL_UNSTAGED_STATS";
    public static final String LOCAL_STAGED_STATS = "LOCAL_STAGED_STATS";
