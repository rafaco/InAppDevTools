...
public class UiUtils {
    ...
    public static void removeHorizontalMargin(View view) {
        addHorizontalMargin(view, 0);
    }

    public static void addHorizontalMargin(View view) {
        ...
        addHorizontalMargin(view, defaultMargin);
    }

    public static void addHorizontalMargin(View view, int marginPx) {
        if (view.getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
            ViewGroup.MarginLayoutParams p = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
    ...
    public static void addVerticalMargin(View view) {
        Context context = IadtController.get().getContext();
        int defaultMargin = (int) context.getResources().getDimension(R.dimen.iadt_vertical_margin);
        addVerticalMargin(view, defaultMargin);
    }

    public static void addVerticalMargin(View view, int marginPx) {
        if (view.getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
            ViewGroup.MarginLayoutParams p = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
