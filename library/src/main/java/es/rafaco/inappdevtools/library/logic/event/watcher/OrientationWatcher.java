...
public class OrientationWatcher extends Watcher implements SensorEventListener{

    SensorManager sm;
    private int previousOrientation = -1;

    public OrientationWatcher(EventManager eventManager) {
        super(eventManager);
    ...
    public void init() {
        ...
        eventManager.subscribe(Event.ORIENTATION_PORTRAIT, new EventManager.OnEventListener() {
            @Override
            public void onEvent(Event event, Object param) {
        ...
        eventManager.subscribe(Event.ORIENTATION_LANDSCAPE, new EventManager.OnEventListener() {
            @Override
            public void onEvent(Event event, Object param) {
