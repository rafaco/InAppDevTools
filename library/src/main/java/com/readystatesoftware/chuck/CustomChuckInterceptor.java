 ...
 *     * (Warning: can contains un-tracked modifications)
 *
 *
 ...
 */
public final class CustomChuckInterceptor implements Interceptor {
    ...
    private static final com.readystatesoftware.chuck.ChuckInterceptor.Period DEFAULT_RETENTION = com.readystatesoftware.chuck.ChuckInterceptor.Period.ONE_WEEK;
     ...
     */
    public CustomChuckInterceptor(Context context) {
     ...
     * @return The {@link com.readystatesoftware.chuck.ChuckInterceptor} instance.
     */
    public CustomChuckInterceptor showNotification(boolean show) {
     ...
     * @return The {@link com.readystatesoftware.chuck.ChuckInterceptor} instance.
     */
    public CustomChuckInterceptor maxContentLength(long max) {
     ...
     * @return The {@link com.readystatesoftware.chuck.ChuckInterceptor} instance.
     */
    public CustomChuckInterceptor retainDataFor(com.readystatesoftware.chuck.ChuckInterceptor.Period period) {
