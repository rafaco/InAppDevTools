...
This project bundles other products with separate copyright
notices and license terms. For details, see [LICENSE](https://github.com/rafaco/InAppDevTools/blob/master/LICENSE) file